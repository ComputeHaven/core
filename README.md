...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [ComputeHaven](https://github.com/ComputeHaven) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for ComputeHaven.
...
```bash
git clone https://github.com/ComputeHaven/core
cd core
go mod download
```
...
- **GitHub Issues:** [github.com/ComputeHaven/issues](https://github.com/ComputeHaven)
- **Discussions:** [github.com/ComputeHaven/discussions](https://github.com/ComputeHaven)
